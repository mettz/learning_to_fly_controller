...
/*****************************************************************************/
#define _STAI_NETWORK_MODEL_SIGNATURE     "0xb2ea751398fb4ff40becb9283da6827b"
#define _STAI_NETWORK_DATETIME            "2025-08-02T16:22:10+0200"
...
static const stai_network_info g_network_info = {
  ...
  .inputs = (stai_tensor[STAI_NETWORK_IN_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 2, 1, 146),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  .activations = (stai_tensor[STAI_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 840),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 55312),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN _actor_actor_mlp_actor_mlp_0_Gemm_output_0 */
  {
      ...
      .bias = (float*)(net_ctx->_weights[0] + 37376),
      .n_channel_in = 146,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _actor_actor_mlp_actor_mlp_1_Tanh_output_0 */
  {
    ...
    const ai_i32 t_in_0_shape_ch_prod_const_s32 = 64;
  
  _STAI_NETWORK_EVENT_NODE_START_CB(2, 1, {(stai_ptr) t_in_0_ptr_const_handle});
    
  forward_lite_nl_tanh_if32of32(t_out_0_ptr_handle, t_in_0_ptr_const_handle, t_in_0_shape_ch_prod_const_s32, NULL);
  ...
  /* LITE_KERNEL_SECTION BEGIN _actor_actor_mlp_actor_mlp_2_Gemm_output_0 */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 37632),
      .bias = (float*)(net_ctx->_weights[0] + 54016),
      .n_channel_in = 64,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  ...
  /* LITE_KERNEL_SECTION BEGIN _actor_mu_Gemm_output_0 */
  {
      ...
      .output = (float*)(net_ctx->_activations[0] + 256),
      .input = (float*)(net_ctx->_activations[0] + 0),
      .weights = (float*)(net_ctx->_weights[0] + 54272),
      .bias = (float*)(net_ctx->_weights[0] + 55296),
      .n_channel_in = 64,
      .n_channel_out = 4,
      .n_elements = 1,
    };
  
  _STAI_NETWORK_EVENT_NODE_START_CB(5, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 0)});
