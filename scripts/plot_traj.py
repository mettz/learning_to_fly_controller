...
def main():
    ...
    t, P, V, spd_seg = load_csv(csv_path)
    ...
    fig3.savefig(f"{out_prefix}_velocity.png", bbox_inches='tight', dpi=300)
    print(f"Saved plots as: {out_prefix}_trajectory3d.png / _position.png / _velocity.png")
